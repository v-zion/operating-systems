...
00000462 <acquire_mutex_spinlock>:
...
0000046a <release_mutex_spinlock>:
...
putc(int fd, char c)
{
 ...
 538:	e8 a5 fe ff ff       	call   3e2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 5a8:	50                   	push   %eax
 5a9:	57                   	push   %edi
 5aa:	e8 33 fe ff ff       	call   3e2 <write>
...
putc(int fd, char c)
{
 ...
 60a:	50                   	push   %eax
 60b:	57                   	push   %edi
 60c:	e8 d1 fd ff ff       	call   3e2 <write>
 ...
 621:	e8 bc fd ff ff       	call   3e2 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 6ef:	50                   	push   %eax
 6f0:	57                   	push   %edi
 6f1:	e8 ec fc ff ff       	call   3e2 <write>
...
malloc(uint nbytes)
{
 ...
 7fe:	53                   	push   %ebx
 7ff:	e8 46 fc ff ff       	call   44a <sbrk>
  if(p == (char*)-1)
