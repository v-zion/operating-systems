...
00000422 <acquire_mutex_spinlock>:
...
0000042a <release_mutex_spinlock>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4bf:	f7 f6                	div    %esi
 4c1:	0f b6 92 6c 08 00 00 	movzbl 0x86c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f8:	e8 a5 fe ff ff       	call   3a2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 568:	50                   	push   %eax
 569:	57                   	push   %edi
 56a:	e8 33 fe ff ff       	call   3a2 <write>
...
putc(int fd, char c)
{
 ...
 5ca:	50                   	push   %eax
 5cb:	57                   	push   %edi
 5cc:	e8 d1 fd ff ff       	call   3a2 <write>
 ...
 5e1:	e8 bc fd ff ff       	call   3a2 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 638:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 63b:	b8 63 08 00 00       	mov    $0x863,%eax
...
putc(int fd, char c)
{
 ...
 6af:	50                   	push   %eax
 6b0:	57                   	push   %edi
 6b1:	e8 ec fc ff ff       	call   3a2 <write>
...
free(void *ap)
{
 ...
 6c1:	a1 10 0b 00 00       	mov    0xb10,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 717:	89 08                	mov    %ecx,(%eax)
  freep = p;
 719:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 71e:	5b                   	pop    %ebx
 71f:	5e                   	pop    %esi
 720:	5f                   	pop    %edi
 ...
 73a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 73d:	a3 10 0b 00 00       	mov    %eax,0xb10
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 10 0b 00 00    	mov    0xb10,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7af:	76 3f                	jbe    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	39 05 10 0b 00 00    	cmp    %eax,0xb10
 ...
 7be:	53                   	push   %ebx
 7bf:	e8 46 fc ff ff       	call   40a <sbrk>
  if(p == (char*)-1)
 ...
 7d6:	e8 e5 fe ff ff       	call   6c0 <free>
  return freep;
 7db:	8b 15 10 0b 00 00    	mov    0xb10,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7ff:	89 15 10 0b 00 00    	mov    %edx,0xb10
      return (void*)(p + 1);
 ...
 814:	eb e9                	jmp    7ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 816:	c7 05 10 0b 00 00 14 	movl   $0xb14,0xb10
 81d:	0b 00 00 
 820:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 827:	0b 00 00 
    base.s.size = 0;
 82a:	b8 14 0b 00 00       	mov    $0xb14,%eax
 82f:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 836:	00 00 00 
