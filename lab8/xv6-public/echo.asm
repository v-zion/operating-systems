...
00000352 <acquire_mutex_spinlock>:
...
0000035a <release_mutex_spinlock>:
...
putc(int fd, char c)
{
 ...
 428:	e8 a5 fe ff ff       	call   2d2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 498:	50                   	push   %eax
 499:	57                   	push   %edi
 49a:	e8 33 fe ff ff       	call   2d2 <write>
...
putc(int fd, char c)
{
 ...
 4fa:	50                   	push   %eax
 4fb:	57                   	push   %edi
 4fc:	e8 d1 fd ff ff       	call   2d2 <write>
...
putc(int fd, char c)
{
 ...
 5df:	50                   	push   %eax
 5e0:	57                   	push   %edi
 5e1:	e8 ec fc ff ff       	call   2d2 <write>
