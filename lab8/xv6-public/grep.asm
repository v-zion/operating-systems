...
00000602 <acquire_mutex_spinlock>:
...
0000060a <release_mutex_spinlock>:
...
putc(int fd, char c)
{
 ...
 6d8:	e8 a5 fe ff ff       	call   582 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 748:	50                   	push   %eax
 749:	57                   	push   %edi
 74a:	e8 33 fe ff ff       	call   582 <write>
...
putc(int fd, char c)
{
 ...
 7aa:	50                   	push   %eax
 7ab:	57                   	push   %edi
 7ac:	e8 d1 fd ff ff       	call   582 <write>
 ...
 7c1:	e8 bc fd ff ff       	call   582 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 83e:	50                   	push   %eax
 83f:	57                   	push   %edi
 840:	e8 3d fd ff ff       	call   582 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 88f:	50                   	push   %eax
 890:	57                   	push   %edi
 891:	e8 ec fc ff ff       	call   582 <write>
...
malloc(uint nbytes)
{
 ...
 99e:	53                   	push   %ebx
 99f:	e8 46 fc ff ff       	call   5ea <sbrk>
  if(p == (char*)-1)
