...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      d3:	68 89 12 00 00       	push   $0x1289
      d8:	6a 02                	push   $0x2
      da:	e8 e1 0d 00 00       	call   ec0 <printf>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     11e:	68 e0 11 00 00       	push   $0x11e0
     123:	6a 02                	push   $0x2
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 7d 12 00 00       	push   $0x127d
     16e:	6a 02                	push   $0x2
...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 98 12 00 00 	jmp    *0x1298(,%eax,4)
    runcmd(lcmd->right);
    break;
...
fork1(void)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     236:	68 ea 11 00 00       	push   $0x11ea
     23b:	6a 02                	push   $0x2
     23d:	e8 7e 0c 00 00       	call   ec0 <printf>
    break;
...
fork1(void)
{
  ...
  default:
    panic("runcmd");
     ...
     292:	68 e3 11 00 00       	push   $0x11e3
     297:	e8 c4 fe ff ff       	call   160 <panic>
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     29f:	68 0a 12 00 00       	push   $0x120a
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2ad:	68 fa 11 00 00       	push   $0x11fa
     2b2:	6a 02                	push   $0x2
     2b4:	e8 07 0c 00 00       	call   ec0 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     2c1:	68 0f 12 00 00       	push   $0x120f
     ...
     341:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     345:	68 0a 12 00 00       	push   $0x120a
     ...
     4a0:	83 c7 01             	add    $0x1,%edi
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4b1:	50                   	push   %eax
     4b2:	68 88 18 00 00       	push   $0x1888
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     556:	50                   	push   %eax
     557:	68 80 18 00 00       	push   $0x1880
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     575:	50                   	push   %eax
     576:	68 88 18 00 00       	push   $0x1888
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 88 18 00 00       	push   $0x1888
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 31 12 00 00       	push   $0x1231
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     6fe:	68 14 12 00 00       	push   $0x1214
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 34 12 00 00       	push   $0x1234
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     776:	68 4b 12 00 00       	push   $0x124b
     77b:	57                   	push   %edi
     77c:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     7c2:	68 3d 12 00 00       	push   $0x123d
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     80d:	68 36 12 00 00       	push   $0x1236
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     83b:	68 50 12 00 00       	push   $0x1250
     840:	56                   	push   %esi
     841:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 52 12 00 00       	push   $0x1252
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 4e 12 00 00       	push   $0x124e
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 34 12 00 00       	push   $0x1234
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     96b:	68 70 12 00 00       	push   $0x1270
     970:	56                   	push   %esi
     971:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     99f:	68 54 12 00 00       	push   $0x1254
  ...
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     ...
     9ac:	68 5f 12 00 00       	push   $0x125f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d9:	ff 24 85 b0 12 00 00 	jmp    *0x12b0(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 f9 11 00 00       	push   $0x11f9
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 72 12 00 00       	push   $0x1272
     ac6:	6a 02                	push   $0x2
     ac8:	e8 f3 03 00 00       	call   ec0 <printf>
    panic("syntax");
     acd:	c7 04 24 36 12 00 00 	movl   $0x1236,(%esp)
...
00000dc2 <acquire_mutex_spinlock>:
...
00000dca <release_mutex_spinlock>:
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     e98:	e8 a5 fe ff ff       	call   d42 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     f08:	50                   	push   %eax
     f09:	57                   	push   %edi
     f0a:	e8 33 fe ff ff       	call   d42 <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     f6a:	50                   	push   %eax
     f6b:	57                   	push   %edi
     f6c:	e8 d1 fd ff ff       	call   d42 <write>
     ...
     f81:	e8 bc fd ff ff       	call   d42 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    104f:	50                   	push   %eax
    1050:	57                   	push   %edi
    1051:	e8 ec fc ff ff       	call   d42 <write>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    115e:	53                   	push   %ebx
    115f:	e8 46 fc ff ff       	call   daa <sbrk>
  if(p == (char*)-1)
