...
fmtname(char *path)
{
  ...
  return buf;
  c5:	bb a0 0d 00 00       	mov    $0xda0,%ebx
  ...
  d7:	05 a0 0d 00 00       	add    $0xda0,%eax
...
00000622 <acquire_mutex_spinlock>:
...
0000062a <release_mutex_spinlock>:
...
putc(int fd, char c)
{
 ...
 6f8:	e8 a5 fe ff ff       	call   5a2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 768:	50                   	push   %eax
 769:	57                   	push   %edi
 76a:	e8 33 fe ff ff       	call   5a2 <write>
...
putc(int fd, char c)
{
 ...
 7ca:	50                   	push   %eax
 7cb:	57                   	push   %edi
 7cc:	e8 d1 fd ff ff       	call   5a2 <write>
...
putc(int fd, char c)
{
 ...
 85e:	50                   	push   %eax
 85f:	57                   	push   %edi
 860:	e8 3d fd ff ff       	call   5a2 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 8af:	50                   	push   %eax
 8b0:	57                   	push   %edi
 8b1:	e8 ec fc ff ff       	call   5a2 <write>
...
free(void *ap)
{
 ...
 8c1:	a1 b0 0d 00 00       	mov    0xdb0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 917:	89 08                	mov    %ecx,(%eax)
  freep = p;
 919:	a3 b0 0d 00 00       	mov    %eax,0xdb0
}
 91e:	5b                   	pop    %ebx
 91f:	5e                   	pop    %esi
 920:	5f                   	pop    %edi
 ...
 93a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 93d:	a3 b0 0d 00 00       	mov    %eax,0xdb0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 15 b0 0d 00 00    	mov    0xdb0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 9af:	76 3f                	jbe    9f0 <malloc+0xa0>
    ...
    if(p == freep)
 9b1:	39 05 b0 0d 00 00    	cmp    %eax,0xdb0
 ...
 9d6:	e8 e5 fe ff ff       	call   8c0 <free>
  return freep;
 9db:	8b 15 b0 0d 00 00    	mov    0xdb0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 9fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 9ff:	89 15 b0 0d 00 00    	mov    %edx,0xdb0
      return (void*)(p + 1);
 ...
 a14:	eb e9                	jmp    9ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a16:	c7 05 b0 0d 00 00 b4 	movl   $0xdb4,0xdb0
 a1d:	0d 00 00 
 a20:	c7 05 b4 0d 00 00 b4 	movl   $0xdb4,0xdb4
 a27:	0d 00 00 
    base.s.size = 0;
 a2a:	b8 b4 0d 00 00       	mov    $0xdb4,%eax
 a2f:	c7 05 b8 0d 00 00 00 	movl   $0x0,0xdb8
 a36:	00 00 00 
