...
00000362 <acquire_mutex_spinlock>:
...
0000036a <release_mutex_spinlock>:
...
putc(int fd, char c)
{
 ...
 438:	e8 a5 fe ff ff       	call   2e2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4a8:	50                   	push   %eax
 4a9:	57                   	push   %edi
 4aa:	e8 33 fe ff ff       	call   2e2 <write>
...
putc(int fd, char c)
{
 ...
 50a:	50                   	push   %eax
 50b:	57                   	push   %edi
 50c:	e8 d1 fd ff ff       	call   2e2 <write>
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 ad 07 00 00       	mov    $0x7ad,%eax
...
putc(int fd, char c)
{
 ...
 5ef:	50                   	push   %eax
 5f0:	57                   	push   %edi
 5f1:	e8 ec fc ff ff       	call   2e2 <write>
