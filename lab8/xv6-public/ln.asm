...
00000342 <acquire_mutex_spinlock>:
...
0000034a <release_mutex_spinlock>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 418:	e8 a5 fe ff ff       	call   2c2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 488:	50                   	push   %eax
 489:	57                   	push   %edi
 48a:	e8 33 fe ff ff       	call   2c2 <write>
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 87 07 00 00       	mov    $0x787,%eax
...
putc(int fd, char c)
{
 ...
 5cf:	50                   	push   %eax
 5d0:	57                   	push   %edi
 5d1:	e8 ec fc ff ff       	call   2c2 <write>
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 2c 0a 00 00       	mov    %eax,0xa2c
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 2c 0a 00 00       	mov    %eax,0xa2c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 2c 0a 00 00 30 	movl   $0xa30,0xa2c
 73d:	0a 00 00 
 740:	c7 05 30 0a 00 00 30 	movl   $0xa30,0xa30
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 30 0a 00 00       	mov    $0xa30,%eax
 74f:	c7 05 34 0a 00 00 00 	movl   $0x0,0xa34
 756:	00 00 00 
