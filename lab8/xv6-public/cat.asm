...
000003f2 <acquire_mutex_spinlock>:
...
000003fa <release_mutex_spinlock>:
...
putc(int fd, char c)
{
 ...
 4c8:	e8 a5 fe ff ff       	call   372 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 538:	50                   	push   %eax
 539:	57                   	push   %edi
 53a:	e8 33 fe ff ff       	call   372 <write>
...
putc(int fd, char c)
{
 ...
 62e:	50                   	push   %eax
 62f:	57                   	push   %edi
 630:	e8 3d fd ff ff       	call   372 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 67f:	50                   	push   %eax
 680:	57                   	push   %edi
 681:	e8 ec fc ff ff       	call   372 <write>
